...
> 痒的时候手想动一下——给它一个能按完、能停下的屏幕动作。

AranCano 是微信小程序上的交互原型：对准真实蚊子包，生成可按的火山包子或火山果冻；长按带动形变、声音和振动，按满后塌陷、封印，一次做完就可以离开。

它**不解痒、不治病**。它管的是更短的那几秒：人已经想抓、掐或搓的时候，手里能不能换成一个有反馈、不伤皮肤的动作。

本页讲产品怎么想、闭环怎么走、为什么暂定主路径用空间贴附。完整说明见 [产品说明](docs/CASE-STUDY.md)。
...
| 下次还会不会开 | 封印、月历、批语留下可回想的完成感；不做排行榜和连续登录催促 | 无人提醒时会不会打开（日记法） |
...
封印是完成凭证，不是金币。批语和月历是为了**下次痒时更容易想起**；会不会真的打开，仍按验证计划用日记法看。
...
以后若要更个人的句子，适合放在**日历或周报里异步生成**（可关）；封印当刻仍用本地句，也不默认上传皮肤原图。识别主路径继续本地红斑检测；难例才考虑可选辅助，且不挡拍照。
